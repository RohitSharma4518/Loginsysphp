...
while($row = mysqli_fetch_assoc($result)){
  echo $row['username']. " ". $row['password']. " " .$row['dt'] ."<br>"; 
}
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <title>WelcomeScreen - <?php echo $_SESSION['username'] ?></title>
  </head>
  <body>
    <?php require('repeatedcode/_navbar.php'); ?>
    <h1 style = "align:center;">Welcome - <?php echo $_SESSION['username'] ?></h1>
